...
import com.dennissand.wissensapp_01.FirestoreStatus
import com.dennissand.wissensapp_01.MainViewModel
import com.dennissand.wissensapp_01.adapter.BoxAdapter
import com.dennissand.wissensapp_01.data.model.Box
import com.dennissand.wissensapp_01.databinding.FragmentBoxHomeBinding
...
class BoxFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = BoxAdapter(emptyList(), deleteBox, navtoDetail, requireContext())
